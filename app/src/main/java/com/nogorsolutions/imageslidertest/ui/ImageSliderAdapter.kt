package com.nogorsolutions.imageslidertest.ui
...
import com.nogorsolutions.imageslidertest.R
...
class ImageSliderAdapter(private val context: Context) : PagerAdapter() {
    ...
    private val images = arrayOf(R.drawable.cesc_1, R.drawable.cesc_2, R.drawable.cesc_3, R.drawable.cesc_4)
